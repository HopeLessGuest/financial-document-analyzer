...
export const FileUpload: React.FC<FileUploadProps> = ({ onFileChange, currentFileName }) => {
  ...
  return (
    <div className="w-full p-6 border-2 border-dashed border-slate-600 hover:border-sky-500 transition-colors duration-300 rounded-lg text-center cursor-pointer bg-slate-700/50" onClick={handleButtonClick}>
      <input
        type="file"
        accept=".pdf"
      ...
      <div className="flex flex-col items-center justify-center space-y-3">
        <UploadCloud size={48} className="text-sky-400" />
        {currentFileName ? (
